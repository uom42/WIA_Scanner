...
namespace uom.WIA2.Scanner
{
	...
	internal class ScannerCaps
	{
		...
		=> new(
			_props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_OPTICAL_XRES, 0),
			_props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_OPTICAL_YRES, 0)
			);
...
=> new(
_props.e_GetPropertyValue(WIA_PROP_ID.WIA_DPS_PAGE_WIDTH, 0) / HUNDREDS_TO_INCHES,
_props.e_GetPropertyValue(WIA_PROP_ID.WIA_DPS_PAGE_HEIGHT, 0) / HUNDREDS_TO_INCHES
);
		 */

		public WIA_PAGE_SIZE PageSizeType
			=> _props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_PAGE_SIZE, WIA_PAGE_SIZE.WIA_PAGE_CUSTOM);


		/// <summary>Page size in Inches</summary>
		public SizeF PageSizeIn
			=> new(
				_props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_IPS_PAGE_WIDTH, 0) / HUNDREDS_TO_INCHES,
				_props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_IPS_PAGE_HEIGHT, 0) / HUNDREDS_TO_INCHES
				);
		...
		public WIA_DPS_DOCUMENT_HANDLING_CAPABILITIES DocumentHandlingCaps
			=> _props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_DOCUMENT_HANDLING_CAPABILITIES, (WIA_DPS_DOCUMENT_HANDLING_CAPABILITIES)0);
		...
		public int DocumentHandlingCapacity
			=> _props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_DOCUMENT_HANDLING_CAPACITY, -1);
		...
		internal class FlatBedCaps
		{
			...
			public SizeF SizeIn
				=> new(
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_HORIZONTAL_BED_SIZE, 0) / THOUSANDS_TO_INCHES,
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_VERTICAL_BED_SIZE, 0) / THOUSANDS_TO_INCHES
					);
			...
			public SizeF MinScanSizeIn
				=> new(
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_IPS_MIN_HORIZONTAL_SIZE, 0) / THOUSANDS_TO_INCHES,
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_IPS_MIN_VERTICAL_SIZE, 0) / THOUSANDS_TO_INCHES
					);

			public SizeF MaxScanSizeIn
				=> new(
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_IPS_MAX_HORIZONTAL_SIZE, 0) / THOUSANDS_TO_INCHES,
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_IPS_MAX_VERTICAL_SIZE, 0) / THOUSANDS_TO_INCHES
					);
			...
			public WIA_HORIZONTAL_REGISTRATIONS HorizontalBedRegistration
				=> _scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_HORIZONTAL_BED_REGISTRATION, WIA_HORIZONTAL_REGISTRATIONS.LEFT_JUSTIFIED);
			...
			public WIA_VERTICAL_BED_REGISTRATIONS VerticalBedRegistration
				=> _scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_VERTICAL_BED_REGISTRATION, WIA_VERTICAL_BED_REGISTRATIONS.TOP_JUSTIFIED);
		...
		internal class FeederCaps
		{
			...
			public SizeF SheetSizeIn
				=> new(
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_HORIZONTAL_SHEET_FEED_SIZE, 0) / THOUSANDS_TO_INCHES,
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_VERTICAL_SHEET_FEED_SIZE, 0) / THOUSANDS_TO_INCHES
				);
			...
			public SizeF MinSheetScanSizeIn
				=> new(
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_MIN_HORIZONTAL_SHEET_FEED_SIZE, 0) / THOUSANDS_TO_INCHES,
					_scanCaps._props.e_GetWiaPropertyValue(WIA_PROP_ID.WIA_DPS_MIN_VERTICAL_SHEET_FEED_SIZE, 0) / THOUSANDS_TO_INCHES
					);
			...
			public WIA_HORIZONTAL_REGISTRATIONS? SheetFeederRegistration
				=> _scanCaps._props.e_GetWiaPropertyValueSafe<WIA_HORIZONTAL_REGISTRATIONS>(WIA_PROP_ID.WIA_DPS_SHEET_FEEDER_REGISTRATION);
