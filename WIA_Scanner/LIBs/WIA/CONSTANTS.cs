...
namespace uom.WIA2
{
	...
	internal static class WIA_Const
	{
		/// <summary>WIA_DPS_PAGES constants</summary>
		internal const int ALL_PAGES = 0;

		#region WIA image format constants (!!! Do not move this into diferent namespace or class! this will broke e_ToFormatGuid(this WIA_IMAGE_FORMATS f) via reflection !!!)
